@extends("layouts.app")
@section('title') Quaida  @endsection

@section('page-header')
<!-- PAGE HEADER -->
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0">Quaida</h4>
            ...
            <form class="needs-validation row" id="add_Quaida_form" novalidate="">
                ...
                <div class="modal-body ">
                    <div class="row mx-2">
                        ...
                        <input name="Quaida_Name" type="text" class="form-control" placeholder="Quaida_Name" required="">
                        ...
                        <input name="Quaida_Words" type="text" class="form-control" placeholder="Quaida_Words" required="">

...
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0" style="color: #006d74;font-size:24px; font-weight:500;">Visitor</h4>
        <ol class="breadcrumb mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="#"> Visitor </a></li>
        </ol>
    </div>
</div>
<!-- END PAGE HEADER -->
            ...
            <form class="needs-validation row" id="add_Quran_form" novalidate="">
                ...
                <div class="modal-body ">
                    ...
                    <div class="col-md-12">
                        ...
                        <input name="ip_address" type="text" class="form-control" placeholder="ip_address" required="">
                        <div class="invalid-feedback"> ip_address is Required.</div>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">visited_at</label>
                        <input name="visited_at" type="text" class="form-control" placeholder="visited_at" required="">

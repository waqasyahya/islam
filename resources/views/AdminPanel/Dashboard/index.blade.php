...
<div class="page-header ">
    <div class="page-leftheader">
        ...
        <ol class="breadcrumb mb-2">
            {{-- <li class="breadcrumb-item"><a href=""><i class="fa-solid fa-chart-tree-map mr-2 fs-12"></i>Dashboard</a> --}}
            </li>
        </ol>
    </div>
</div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Islameapp</span>
                                <img class="img-profile rounded-circle"
                                    src="/image/WIthColor_logo.png">
                            </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Project Manager</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 16px;">Qamar Chishti</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800" style="font-size: 16px;">Waqas Yahya</div>
                                        </div>
                                        <div class="col-auto">

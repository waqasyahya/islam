@extends("layouts.app")
@section('title') QuranAyatWithAnswer  @endsection

@section('page-header')
<!-- PAGE HEADER -->
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0" style="color: #006d74;font-size:24px; font-weight:500;">QuranAyatWithAnswer</h4>
        <ol class="breadcrumb mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="#"> QuranAyatWithAnswer </a></li>
        </ol>
    </div>
</div>
<!-- END PAGE HEADER -->
            ...
            <form class="needs-validation row" id="add_AnswerAyats_form" novalidate="">
                ...
                <div class="modal-body ">
                    <div class="row mx-2">
                        ...
                        <input name="TestingAyats_id" type="text" class="form-control" placeholder="TestingAyats_id" required="">

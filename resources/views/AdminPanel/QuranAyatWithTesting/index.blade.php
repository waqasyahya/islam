@extends("layouts.app")
@section('title') QuranAyatWithTesting  @endsection

@section('page-header')
<!-- PAGE HEADER -->
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0" style="color: #006d74;font-size:24px; font-weight:500;">QuranAyatWithTesting</h4>
        <ol class="breadcrumb mb-2">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"><i class="fa-solid fa-chart-tree-map mr-2 fs-12" style="color: #006d74;font-size:24px; font-weight:500;"></i>Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="#"> QuranAyatWithTesting </a></li>
        </ol>
    </div>
</div>
<!-- END PAGE HEADER -->
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createBookingModalLabel">Create QuranAyatWithTesting </h5>
            ...
            <form class="needs-validation row" id="add_AnswerAyats_form" novalidate="">
                ...
                <div class="modal-body ">
                    ...
                    <div class="col-md-12">
                        ...
                        <input name="option_1" type="text" class="form-control" placeholder="option_1" required="">
                        <div class="invalid-feedback"> option_1 is Required.</div>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label">option_2</label>
                        <input name="option_2" type="text" class="form-control" placeholder="option_2" required="">
...
$("#add_AnswerAyats_form").submit(function(e) {
    ...
    if (form.checkValidity() === true) {
        ...
        var Quran_id = document.forms["add_AnswerAyats_form"]["Quran_id"].value;
        var option_1 = document.forms["add_AnswerAyats_form"]["option_1"].value;
        var option_2 = document.forms["add_AnswerAyats_form"]["option_2"].value;
      

        $.ajax({
            type: "GET",
            url: "{{route('QuranAyatWithTesting.store')}}",
            data: {
                id: id,
                Quran_id: Quran_id,
                option_1: option_1,
...
function Answer_read_by_id(id) {
    $.ajax({
        type: "GET",
        url: "{{ route('QuranAyatWithTesting.readbyid', ['id' => '']) }}/" + id,
        dataType: "json",
        data: {
            "_token": "{{ csrf_token() }}"
        },
        success: function(response) {
            ...
            document.forms["add_AnswerAyats_form"]["Quran_id"].value = response.Quran_id;
            document.forms["add_AnswerAyats_form"]["option_1"].value = response.option_1;
            document.forms["add_AnswerAyats_form"]["option_2"].value = response.option_2;
...
function Answer_delete(id) {
    $.ajax({
        type: "GET",
        url: "{{ route('QuranAyatWithTesting.delete', ['id' => '']) }}/" + id,
        dataType: "json",
        data: {
            "_token": "{{ csrf_token() }}"
        },
...
<script>
    ...
    $(document).ready(function() {
        dataTable = $("#example").DataTable({
            "ajax": {
                url: "{{route('QuranAyatWithTesting.read')}}",
                type: "GET",
                data: {
                    "_token": "{{ csrf_token() }}"
                }

                    ...
                    <div class="modal-body ">
                        <div class="row mx-2">
                            <div class="col-md-12">
                                ...
                                <input name="Ayat_Name" type="text" class="form-control" placeholder="Ayat_Name"
                                    required="">
                                <div class="invalid-feedback"> Ayat_Name is Required.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Ayat_Referance</label>
                                <input name="Ayat_Referance" type="text" class="form-control"
                                    placeholder="Ayat_Referance" required="">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="Hadith_Arabic" type="text" class="form-control"
                                        placeholder="Hadith_Arabic" required="">
                                    <div class="invalid-feedback"> Hadith_Arabic is Required.</div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Hadith_Translate</label>
                                <input name="Hadith_Translate" type="text" class="form-control"
                                    placeholder="Hadith_Translate" required="">
                                <div class="invalid-feedback"> Hadith_Translate is Required.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Hadith_Name</label>
                                <input name="Hadith_Name" type="text" class="form-control" placeholder="Hadith_Name"
                                    required="">
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="Hadith_Referance" type="text" class="form-control"
                                    placeholder="Hadith_Referance" required="">
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="Ayat_Translate" type="text" class="form-control"
                                    placeholder="Ayat_Translate" required="">

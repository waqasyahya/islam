@extends("layouts.app")
@section('title') QuranWordWithAnswer  @endsection

@section('page-header')
<!-- PAGE HEADER -->
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0">QuranWordWithAnswer</h4>
        <ol class="breadcrumb mb-2">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}"><i class="fa-solid fa-chart-tree-map mr-2 fs-12"></i>Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="#"> QuranWordWithAnswer </a></li>
        </ol>
    </div>
</div>
<!-- END PAGE HEADER -->
                ...
                <div class="modal-body ">
                    <div class="row mx-2">
                        <div class="col-md-12">
                            ...
                            <input name="TestingWords_id" type="text" class="form-control" placeholder="TestingWords_id" required="">
...
function read_read_by_id(id) {
    $.ajax({
        ...
        success: function(response) {
            ...
            document.forms["add_QuranWithWord_form"]["TestingWords_id"].value = response.TestingWords_id;

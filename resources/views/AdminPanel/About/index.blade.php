        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createBookingModalLabel">Create </h5>
                    ...
                    <div class="modal-body ">
                        <div class="row mx-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="Heading" type="text" class="form-control" placeholder="detaillesson_id"
                                    required="">
                                <div class="invalid-feedback"> Heading is Required.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">detailpara</label>
                                <input name="detailpara" type="text" class="form-control" placeholder="detailpara"
                                    required="">

...
@section('content')
                        ...
                        <div class="row mx-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="testing_id" type="text" class="form-control" placeholder="testing_id"
                                        required="">
    ...
    <script>
        ...
        function Answer_read_by_id(id) {
            $.ajax({
                type: "GET",
                url: "{{ route('QuaidaAnswer.readbyid', ['id' => '']) }}/" + id,
                dataType: "json",
                data: {
                    "_token": "{{ csrf_token() }}"
                },
        ...
        function Answer_delete(id) {
            $.ajax({
                type: "GET",
                url: "{{ route('QuaidaAnswer.delete', ['id' => '']) }}/" + id,
                dataType: "json",
                data: {
                    "_token": "{{ csrf_token() }}"
                },

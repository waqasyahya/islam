@extends("layouts.app")
@section('title') Quran  @endsection

@section('page-header')
<!-- PAGE HEADER -->
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0" style="color: #006d74;font-size:24px; font-weight:500;">Quran</h4>
        <ol class="breadcrumb mb-2">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="#"> Quaida </a></li>
        </ol>
    </div>
</div>
<!-- END PAGE HEADER -->
                ...
                <div class="modal-body ">
                    <div class="row mx-2">
                        <div class="col-md-12">
                            ...
                            <label class="form-label">Quran_Name</label>
                        <input name="Quran_Name" type="text" class="form-control" placeholder="Quran_Name" required="">
                        <div class="invalid-feedback"> Quran_Name is Required.</div>
                            </div>
                        </div>
                    <div class="col-md-12">
                        <label class="form-label">Quran_words</label>
                        <input name="Quran_words" type="text" class="form-control" placeholder="Quran_words" required="">
                        <div class="invalid-feedback"> Quran_words is Required.</div>
                    </div>
...
$("#add_Quran_form").submit(function(e) {
    ...
    if (form.checkValidity() === true) {
        ...
        var Quran_Name = document.forms["add_Quran_form"]["Quran_Name"].value;
        var Quran_words = document.forms["add_Quran_form"]["Quran_words"].value;
      

        $.ajax({
            type: "GET",
            url: "{{route('Quran.store')}}",
            data: {
                id: id,
...
function read_read_by_id(id) {
    $.ajax({
        type: "GET",
        url: "{{ route('Quran.readbyid', ['id' => '']) }}/" + id,
        dataType: "json",
        data: {
            "_token": "{{ csrf_token() }}"
        },
        success: function(response) {
            ...
            document.forms["add_Quran_form"]["Quran_Name"].value = response.Quran_Name;
            document.forms["add_Quran_form"]["Quran_words"].value = response.Quran_words;

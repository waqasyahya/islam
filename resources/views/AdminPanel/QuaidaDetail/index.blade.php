                    ...
                    <div class="modal-body ">
                        <div class="row mx-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <input name="Words_Arabic" type="text" class="form-control" placeholder="Words_Arabic"
                                    required="">
                                <div class="invalid-feedback"> Words_Arabic is Required.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Words_id</label>
                                <input name="Words_id" type="text" class="form-control" placeholder="Words_id"
                                    required="">
                                <div class="invalid-feedback"> Words_id is Required.</div>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Words_Urdu</label>
                                <input name="Words_Urdu" type="text" class="form-control" placeholder="Words_Urdu"
                                    required="">

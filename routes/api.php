...
Route::post('/submitAnswerQuaida/{questionId}/{selectedOption}', [QuaidaAppAnswerController::class, 'submitAnswerApp']);
...
Route::post('/submitAnswerAppQuranWord/{questionId}/{selectedOption}', [QuranAPPWithAnswerController::class, 'submitAnswerAppQuranWord']);
...
Route::post('/submitAnswerAppQuranAyat/{questionId}/{selectedOption}', [QuranAppAyatWithAnswerController::class, 'submitAnswerAppQuranAyat']);
